...
#define WILD_METAS      "*?"
    ...
    #define ENTRY_CHANGED1(n1,n2)       (_access(n2, R_OK) == -1 || chk_is_archived(n1))
    #define ENTRY_CHANGED2(n1,e1,n2)    (_access(n2, R_OK) == -1 || (e1->d_attr & _A_ARCH) != 0)
#endif
...
int RunIt( const char *cmd, bool ignore_errors, bool *res_nolog )
{
    ...
    #define BUILTIN( c, b )     (_strnicmp( (c), b, sizeof( b ) - 1 ) == 0 && (c)[sizeof( b ) - 1] == ' ')
