...
{
	HashTableDataPtr table = (HashTableDataPtr)memory->AllocateMemory(sizeof(HashTable));
	table->tbl = (HashTableElementPtrPtr)memory->AllocateMemory(sizeof(table[0]) * size);
