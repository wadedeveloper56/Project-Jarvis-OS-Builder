...
//void Ring::RINGNAME(Append) (         // APPEND ELEMENT TO RING
...
//}
//
//void* Ring::RINGNAME(Alloc) (         // ALLOCATE AND APPEND NEW ELEMENT
//	void* hdr,                  // - addr( ring header )
//	size_t size)               // - size of entry to be allocated
//{
//	void* new_element=nullptr;          // - allocated element
//
//	//FIX ME _ChkAlloc(void*, new_element, size);
