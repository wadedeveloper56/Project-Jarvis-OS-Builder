...
#define _ClientRead( a, b )             (((a)->implib_data != nullptr) ? ImportLibData.read( a, b ) : (a)->coff_hnd->funcs->read( a->file, b ))
#define _ClientSeek( a, b, c )          (((a)->implib_data != nullptr) ? ImportLibData.seek( a, b, c ) : (a)->coff_hnd->funcs->seek( a->file, b, c ))
