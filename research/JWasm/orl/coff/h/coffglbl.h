...
#define _ClientRead( a, b )             (((a)->implib_data != NULL) ? ImportLibData._read( a, b ) : (a)->coff_hnd->funcs->_read( a->file, b ))
...
#define _ClientSecRead( a, b )          ((a)->coff_file_hnd->coff_hnd->funcs->_read( a->coff_file_hnd->file, b ))
