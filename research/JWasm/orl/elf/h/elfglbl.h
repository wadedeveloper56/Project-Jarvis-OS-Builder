...
#define _ClientAlloc( a, b )            ((a)->elf_hnd->funcs->mem->AllocateMemory( b ))
#define _ClientFree( a, b )             ((a)->elf_hnd->funcs->mem->FreeMemory( b ))
#define _ClientReAlloc( a, b, c )       ((a)->elf_hnd->funcs->mem->ReallocateMemory( b, c ))
...
#define _ClientSecAlloc( a, b )         ((a)->elf_file_hnd->elf_hnd->funcs->mem->AllocateMemory( b ))
#define _ClientSecFree( a, b )          ((a)->elf_file_hnd->elf_hnd->funcs->mem->FreeMemory( b ))
