...
class AFX_EXT_CLASS CScintillaFindReplaceDlg : public CFindReplaceDialog
{
public:
...
class AFX_EXT_CLASS CScintillaEditState
{
public:
	//Constructors / Destructors
...
class AFX_EXT_CLASS CScintillaView : public CView
{
public:
	//Constructors / Destructors
	CScintillaView();
...
class AFX_EXT_CLASS CScintillaDoc : public CDocument
{
