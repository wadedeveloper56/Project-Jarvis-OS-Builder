 ...
 *     logsin lookup table (logsin_wf, in nukedopl_wf_rom.h). With
 *     OPL_WF_TABLE_RUNTIME=1 the table is instead built from the base
 *     logsinrom[256] at the first OPL3_Reset and nukedopl_wf_rom.h is not used.
 ...
 * nukedopl_wf_rom.h (gen_logsin.py documents the derivation). */
