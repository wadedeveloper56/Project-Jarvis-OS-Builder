    ...
    )
{
    ...
    va_debug_dir = GetImgDirEntryRVA(
        pNTHeader,
    ...
    {
        header = GetEnclosingSectionHeader(
            va_debug_dir,
            pNTHeader
            );
        ...
        debugDir = MakePtr(
            ...
            base,
            header->PointerToRawData + (va_debug_dir - header->VirtualAddress)
            );
    }
    ...
    )
{
    ...
    importsStartRVA = GetImgDirEntryRVA(
        pNTHeader,
    ...
    importDesc = (PIMAGE_IMPORT_DESCRIPTOR) GetPtrFromRVA(
        importsStartRVA,
        pNTHeader,
        base
        );
    ...
    {
        printf(
            "TODO: (PIMAGE_IMPORT_DESCRIPTOR)GetPtrFromRVA failed RVA %08X\n",
            importsStartRVA
            );
    ...
    while (true)
    {
        ...
        {
            printf(
                "TODO: (char *)GetPtrFromRVA failed RVA %08X\n",
                importDesc->Name
                );
            break;
        }
        ...
        printf(
            "  OrigFirstThunk:  %08X (Unbound IAT)\n",
        ...
        thunk = (PIMAGE_THUNK_DATA32) GetPtrFromRVA(
            dwthunk,
            pNTHeader,
            base
            );
        ...
        {
            printf(
                "TODO: (PIMAGE_THUNK_DATA32)GetPtrFromRVA failed RVA %08X\n",
                dwthunk
                );
        ...
        thunkIAT = (PIMAGE_THUNK_DATA32) GetPtrFromRVA(
            dwthunkIAT,
            pNTHeader,
            base
            );
        ...
        while (true)
        {
            ...
            else
            {
                ...
                {
                    printf(
                        "TODO: (PIMAGE_IMPORT_BY_NAME)GetPtrFromRVA failed RVA %08X\n",
                        dwOff
                        );
                    break;
                }
    ...
    printf(
        "Done %u imports... total %u entries...\n",
        count,
        totentries
        );
}
    ...
    )
{
    ...
    {
        printf(
            "TODO: (PIMAGE_IMPORT_DESCRIPTOR) GetPtrFromRVA failed with RVA %08X\n",
            importsStartRVA
            );
    ...
    while (true)
    {
        ...
        {
            printf(
                "TODO: (char *)GetPtrFromRVA from RVA %08X\n",
                importDesc->Name
                );
            break;
        }
        ...
        thunk = (PIMAGE_THUNK_DATA64) GetPtrFromRVA(
            dwthunk,
            pNTHeader,
            base
            );
        ...
        {
            printf(
                "TODO: (PIMAGE_THUNK_DATA64)GetPtrFromRVA from RVA %08X\n",
                dwthunk
                );
        ...
        thunkIAT = (PIMAGE_THUNK_DATA64) GetPtrFromRVA(
            dwthunkIAT,
            pNTHeader,
            base
            );
        ...
        {
            printf(
                "TODO: (PIMAGE_THUNK_DATA64)GetPtrFromRVA failed with RVA %08X\n",
                dwthunkIAT
                );
        ...
        while (true)
        {
            ...
            if (fShowIATentries || importDesc->TimeDateStamp)
            {
                printf(
                    " (Bound to: %08llX)",
                    (unsigned long long) thunkIAT->u1.Function
                    );
            }
    ...
    )
{
    ...
    PIMAGE_RUNTIME_FUNCTION_ENTRY pRTFn = (PIMAGE_RUNTIME_FUNCTION_ENTRY) GetPtrFromRVA(
        rtFnRVA,
        pNTHeader,
        base
        );
    ...
    {
        printf(
            "TODO: (PIMAGE_RUNTIME_FUNCTION_ENTRY)GetPtrFromRVA failed RVA %08X\n",
            rtFnRVA
            );
    ...
    printf(
        "Runtime Function Table (Exception handling) - count %lu\n",
        cEntries
        );
    ...
    for (unsigned i = 0; i < cEntries; i++, pRTFn++)
    {
        ...
        printf(
            ...
            pRTFn->BeginAddress,
            pRTFn->EndAddress,
            pRTFn->ExceptionHandler,
            pRTFn->HandlerData,
            pRTFn->PrologEndAddress
            );
#else
        printf(
            "  %08X  %08X",
    ...
    {
        printf(
            "TODO: Get symbol name 32/64 bits... using g_pCOFFSymbolTable - %p\n",
            g_pCOFFSymbolTable
            );
    }
}
    ...
    )
{
    ...
    baseReloc = (PIMAGE_BASE_RELOCATION) GetPtrFromRVA(
        dwBaseRelocRVA,
        pNTHeader,
        base
        );
    ...
    {
        printf(
            "TODO: (PIMAGE_BASE_RELOCATION)GetPtrFromRVA failed RVA %08X\n",
            dwBaseRelocRVA
            );
    ...
    )
{
    ...
    if (
        !IsAddressInRange(
            (BYTE*) pibid,
            (int) sizeof(IMAGE_BOUND_IMPORT_DESCRIPTOR)
            )
        )
    {
        printf(
            "TODO: DumpBoundImportDescriptors PIMAGE_BOUND_IMPORT_DESCRIPTOR out of range - %p\n",
            pibid
            );
    ...
    while (pibid->TimeDateStamp)
    {
        ...
        {
            printf(
                "TODO: DumpBoundImportDescriptors pMod out of range - %p\n",
                pMod
                );
...
void
DumpExeFile(PIMAGE_DOS_HEADER dosHeader)
{
    PIMAGE_NT_HEADERS pNTHeader;
    ...
    {
        printf(
            "Is NOT a PE32 nor PE32+ magic value! Got %x\n",
    ...
    if (
        DoesSectionExist("EXPORT") && GetImgDirEntryRVA(
            pNTHeader,
            IMAGE_DIRECTORY_ENTRY_EXPORT
            )
        )
