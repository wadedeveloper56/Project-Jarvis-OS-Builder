...
extern int64_t _passn;
extern FILE* error_file;
extern const char* _progname;
extern struct compile_time official_compile_time;
extern iflag_t cpu;
extern iflag_t cmd_cpu;
extern unsigned char nasm_tolower_tab[256];
extern const struct limit_info limit_info[LIMIT_MAX + 1];
extern int64_t nasm_limit[LIMIT_MAX + 1];
extern struct strlist* include_path;
extern bool want_usage;
extern bool terminate_after_phase;
extern uint16_t nasm_ctype_tab[256];
extern union label* ldata;              /* all label data blocks */
extern union label* lfree;              /* labels free block */
extern struct permts* perm_head;        /* start of perm. text storage */
extern struct permts* perm_tail;        /* end of perm. text storage */
extern const char* prevlabel;
...
fatal_func nasm_critical(const char* fmt, ...);
