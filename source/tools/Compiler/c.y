...
declaration
    ...
    | declaration_specifiers init_declarator_list SEMI_OP   {
                                                             ...
                                                             $<CompilerInfo>$.data.emptyArray = $<CompilerInfo>2.data.emptyArray;                                                            $<CompilerInfo>$.data.emptyArray = $<CompilerInfo>2.data.pointerLevel;
...
declaration_specifiers
    ...
    | storage_class_specifier declaration_specifiers {
                                                      ...
                                                      $<CompilerInfo>$.data.storage = $<CompilerInfo>1.data.storage;
                                                      $<CompilerInfo>$.data.pointerLevel = $<CompilerInfo>2.data.pointerLevel;
                                                      $<CompilerInfo>$.data.emptyArray = $<CompilerInfo>2.data.emptyArray;
...
direct_declarator
    ...
    | direct_declarator OPENBRACE_OP CLOSEBRACE_OP                                                    {
                                                                                                       $<CompilerInfo>$ = $<CompilerInfo>1;
                                                                                                       $<CompilerInfo>$.data.emptyArray = TRUE;
                                                                                                       //addToExpression2(&$<CompilerInfo>$.arrayExpression,"",0,0,FALSE);
                                                                                                       printCompilerInfoNode("direct_declarator OPENBRACE_OP CLOSEBRACE_OP REDUCE to direct_declarator",&$<CompilerInfo>$);
                                                                                                      }
...
translation_unit
    : external_declaration                  {
                                             $<CompilerInfo>$ = $<CompilerInfo>1;
                                             addToSymbolTable($<CompilerInfo>1.data.pointerLevel,$<CompilerInfo>1.data.identifier, $<CompilerInfo>1.data.type, $<CompilerInfo>1.data.sign, $<CompilerInfo>1.data.storage, $<CompilerInfo>1.data.declarationType, $<CompilerInfo>1.data.constant, $<CompilerInfo>1.data.emptyArray, $<CompilerInfo>1.arrayExpression);
    ...
    | translation_unit external_declaration {
                                             $<CompilerInfo>$ = $<CompilerInfo>2;
                                             addToSymbolTable($<CompilerInfo>2.data.pointerLevel,$<CompilerInfo>2.data.identifier, $<CompilerInfo>2.data.type, $<CompilerInfo>2.data.sign, $<CompilerInfo>2.data.storage, $<CompilerInfo>2.data.declarationType, $<CompilerInfo>2.data.constant, $<CompilerInfo>2.data.emptyArray, $<CompilerInfo>2.arrayExpression);
