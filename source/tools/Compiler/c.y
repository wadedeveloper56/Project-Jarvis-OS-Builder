...
storage_class_specifier
	: TYPEDEF  {$<CompilerInfo>$.storage = STORAGE_NONE;     fprintf(fileLexLog,"TYPEDEF REDUCE to storage_class_specifier\n");}
	| EXTERN   {$<CompilerInfo>$.storage = STORAGE_EXTERN;   fprintf(fileLexLog,"EXTERN REDUCE to storage_class_specifier\n");}
	| STATIC   {$<CompilerInfo>$.storage = STORAGE_STATIC;   fprintf(fileLexLog,"STATIC REDUCE to storage_class_specifier\n");}
	| AUTO     {$<CompilerInfo>$.storage = STORAGE_AUTO;     fprintf(fileLexLog,"AUTO REDUCE to storage_class_specifier\n");}
	| REGISTER {$<CompilerInfo>$.storage = STORAGE_REGISTER; fprintf(fileLexLog,"REGISTER REDUCE to storage_class_specifier\n");}
	;
