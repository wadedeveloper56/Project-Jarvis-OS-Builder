...
# if 201103L <= YY_CPLUSPLUS
        ...
        switch (this->kind ())
    {
      ...
      {}
#else
			basic_symbol(typename Base::kind_type t, const std::vector<AssignmentExpression*>*& v,
      ...
      {}
#else
			basic_symbol(typename Base::kind_type t, const std::vector<ParameterDeclaration*>*& v,
			             const location_type& l)
				: Base(t)
				  , value(v)
				  , location(l)
