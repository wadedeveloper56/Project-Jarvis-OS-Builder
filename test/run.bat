...
C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\x64\JWasm -win64 -Fl=bin\windows\x64\test1.lst -Sa -Fobin\windows\x64\test1.obj test1.asm
...
C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\WIn32\JWlinkOld  format win pe ru win file win64_1.obj op start=main lib %LIB64%,%KLIB64% 