...
C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\x64\JWlinker format win pe option map=bin\windows\x64\test1.map file bin\windows\x64\test1.obj, bin\windows\x64\c064.obj lib %LIB64%,%KLIB64%  name bin\windows\x64\test1.exe
...
C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\x64\JWlinker format win pe option map=bin\windows\x86\test1.map file bin\windows\x86\test1.obj, bin\windows\x86\c032.obj lib %LIB32%,%KLIB32%  name bin\windows\x86\test1.exe
...
C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\x64\JWlinker  format win pe ru win file win64_1.obj op start=main