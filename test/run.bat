...
REM C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\Win32\JWlink format win pe option map=bin\windows\x64\test1.map file bin\windows\x64\test1.obj, bin\windows\x64\c064.obj lib %LIB64%,%KLIB64%  name bin\windows\x64\test1.exe
...
REM C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\Win32\JWlink  format win pe ru win file win64_1.obj op start=main