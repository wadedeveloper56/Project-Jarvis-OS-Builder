...
C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\Win32\JWlink format win pe option map=bin\windows\x64\test1.map file bin\windows\x64\test1.obj, bin\windows\x64\c064.obj lib %LIB64%,%KLIB64%  name bin\windows\x64\test1.exe
...
REM C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\x64\JWcc -b 32 -o bin\windows\x86\test1.asm test1.c > bin\windows\x86\test1.c.log
REM C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\x64\JWasm -coff -Fl=bin\windows\x86\test1.lst -Sa -Fobin\windows\x86\test1.obj test1.asm
REM C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\x64\JWasm -coff -Fl=bin\windows\x86\c032.lst -Sa -Fobin\windows\x86\c032.obj c032.asm
REM C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\Win32\JWlink format win pe option map=bin\windows\x86\test1.map file bin\windows\x86\test1.obj, bin\windows\x86\c032.obj lib %LIB32%,%KLIB32%  name bin\windows\x86\test1.exe
REM C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\x64\pedump -a bin\windows\x86\test1.obj > bin\windows\x86\test1.asm.log
REM C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\x64\pedump -a bin\windows\x86\c032.obj > bin\windows\x86\c032.asm.log
