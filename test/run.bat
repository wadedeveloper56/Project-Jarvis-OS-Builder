...
C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\x64\JWlink format win pe option map=%CD%\bin\windows\x64\test1.map file %CD%\bin\windows\x64\test1.obj, %CD%\bin\windows\x64\c064.obj lib %LIB64%,%KLIB64%,%LLIB64%  name %CD%\bin\windows\x64\test1.exe
...
C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\x64\JWlink format win pe option map=%CD%\bin\windows\x86\test1.map file %CD%\bin\windows\x86\test1.obj, %CD%\bin\windows\x86\c032.obj lib %LIB32%,%KLIB32%  name %CD%\bin\windows\x86\test1.exe
...
C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\x64\JWmake --help --version
C:\projects\OSDev\ProjectJarvis\bin\tools\Debug\x64\JWcpp --help --version
